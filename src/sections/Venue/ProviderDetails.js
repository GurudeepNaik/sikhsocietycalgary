  ...
  const getComponents = () => {
    ...
    for (let property in details) {
      if (
        ...
        let propertyName = "";
        if (property === "venuename") propertyName = "Venue Name";
        else if (property === "contactname") propertyName = "Contact Name";
        ...
        else if (property === "gigrules") propertyName = "Gig Rules";
        else if (property === "instagramaccount") propertyName = "Instagram Account";
        else if (property === "paymentmethod") propertyName = "Payment Method";
        else if (property === "websiteurl") propertyName = "Website Url";
