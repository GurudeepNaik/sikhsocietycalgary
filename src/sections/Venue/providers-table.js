                  ...
                  <TableRow hover key={customer?._id} selected={isSelected}>
                    ...
                    <TableCell onClick={() => onRowClick(customer)}>
                      <Stack alignItems="center" direction="row" spacing={2}>
                        <Typography variant="subtitle2">{customer?.venuename}</Typography>
                      </Stack>
                    </TableCell>
                    <TableCell onClick={() => onRowClick(customer)}>{customer?.contactname}</TableCell>
                    ...
                    <TableCell onClick={() => onRowClick(customer)}>{customer?.type}</TableCell>
